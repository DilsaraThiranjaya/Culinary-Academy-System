...
public class RegistorController {
    ...
    RegistorBO registorBO = (RegistorBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.REGISTOR);
    ...
    private void initializeCmb() {
        try {
            cmbEmployees.setItems(registorBO.getAllEmployees());
...
// Move the window by the mouse delta
    ...
    void btnSendOtpOnAction(ActionEvent event) {
        ...
        if(employeeId != null && !employeeId.isEmpty()){
            ...
            try {
                employee = registorBO.searchEmployeeById(employeeId);
            } catch (SQLException | ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
